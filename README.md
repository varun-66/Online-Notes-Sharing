...
Allows multiple type of users(teacher/student/admin) to login

# Functional Admin panel: 
Allows admins to manage the whole system

# CRUD functionalities: 
Allows all users to create,read,update and delete their notes in a managed format

# Profile update option: 
Allows users to update their profile/account details
